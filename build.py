...
PAGES = {
  "index": {
    "title": "Flyover Con &ndash; The Midwest's Conference for Screen Printers &amp; Decorators",
  ...
  "years-past": {
    "title": "Years Past &ndash; Flyover Con Schedule Archive",
  ...
  "speakers": {
    "title": "Speakers &ndash; Flyover Con Alumni",
  ...
  "location": {
    "title": "Location &ndash; Flyover Con at P&amp;M Apparel, Polk City, Iowa",
...
def render(key):
    page = PAGES[key]
    year_filter = {"speakers": "2026"}.get(key)
    body = page["main"].replace("__SPEAKER_GRID__", speaker_grid(year=year_filter))
    body = body.replace("__SPEAKERS_2026__", speaker_mini(year="2026"))
...
Flyover Con is a hands-on, free-to-attend conference for Midwest screen printers and decorators, hosted inside P&M Apparel's working production facility. No vendor booths, no sales pitches &ndash; real shop-floor learning from people who run print and embroidery shops every day.
