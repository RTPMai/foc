...
PAGES = {
  ...
  "speakers": {
    ...
    "main": f"\n\n<section class=\"hero\" style=\"padding:56px 0;\">\n  <div class=\"container hero__inner\">\n    <div class=\"hero__eyebrow\">FOC27</div>\n    <h1 style=\"font-size:clamp(2.2rem,5vw,3.4rem);\">Speakers</h1>\n    <p class=\"hero__lead\">FOC27 is April 16 and 17, 2027. The lineup hasn't been announced yet. Want to see who spoke last time? Check the Years Past archive.</p>\n  </div>\n</section>\n\n<section>\n  <div class=\"container\">\n    <div class=\"plaque\" style=\"margin-bottom:24px;\">\n      <p class=\"plaque__text\">Speakers TBD</p>\n    </div>\n    <p style=\"max-width:60ch;color:var(--grey);\">We're not booking speakers for FOC27 yet. Know your shop's story is worth sharing? <a href=\"mailto:ryan@flyovercon.ink\" style=\"color:var(--navy);font-weight:600;\">Reach out</a> or <a href=\"{MAILME_URL}\" rel=\"noopener\" target=\"_blank\" style=\"color:var(--navy);font-weight:600;\">join the FOC27 list</a> to hear when the call for speakers opens.</p>\n    <p style=\"margin-top:24px;\"><a class=\"btn btn--outline\" href=\"/years-past\">See Past Speakers</a></p>\n  </div>\n</section>\n"
  },
  "location": {
...
{items}      <li><a class="site-nav__cta" href="{MAILME_URL}" rel="noopener" target="_blank">Stay In The Loop</a></li>
    </ul>
  </div>
</header>
...
FOC27 is confirmed for April 16 and 17, 2027, at the same location, capped at 75 attendees. Schedule, speakers, and sponsors are not yet announced as of {UPDATED_HUMAN}.
