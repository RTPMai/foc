...
NAV = [("/","Home"),("/about","About"),("/schedule","Schedule"),
       ("/speakers","Speakers"),("/sponsor","Sponsor"),
       ("/location","Location"),("/years-past","Years Past")]

# /speak stays out of NAV on purpose. "Speakers" and "Speak" sitting next to
# each other reads as a typo, so the call for speakers is reached from the
# Speakers page, the homepage and the footer instead.
      ...
      <nav class="site-footer__nav">
        ...
        <div class="site-footer__col">
          ...
          <ul>
            ...
            <li><a href="{NOTIFY_URL}">Get FOC27 Updates</a></li>
          </ul>
        </div>
        <div class="site-footer__col">
          <h5>Presented By</h5>
