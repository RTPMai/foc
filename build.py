...
COPY_FILES = ["api/survey.js", "api/notify.js"]
...
PAGES = {
  ...
  "notify": {
    "title": "Get FOC27 Updates | Flyover Con",
...
{items}      <li><a class="site-nav__cta" href="{NOTIFY_URL}">Stay In The Loop</a></li>
    </ul>
  </div>
</header>
